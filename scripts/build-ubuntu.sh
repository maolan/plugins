...
# build-ubuntu.sh — Build a .deb package for Maolan CLAP Plugins on Ubuntu.
#
# Usage:
...
Depends: libavcodec62, libavdevice62, libavfilter11, libavformat62, libavutil60, libswresample6, libx11-6, libxcb1, libxkbcommon0, libxkbcommon-x11-0
