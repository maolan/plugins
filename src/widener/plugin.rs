...
const PLUGIN_DESCRIPTION: &[u8] = b"Rust CLAP Widener\0";
...
impl PluginInstance {
    fn new(host: *const clap_host) -> Self {
        ...
        let mut bus_data = bus::PluginSharedData::new(bus::PluginType::Widener).with_fft(bus::FftData::default());
...
unsafe extern "C-unwind" fn ext_gui_is_api_supported(
    ...
    crate::widener::gui::is_api_supported(api, is_floating)
}
...
unsafe extern "C-unwind" fn ext_gui_get_preferred_api(
    ...
    let preferred = crate::widener::gui::preferred_api();
    unsafe {
...
unsafe extern "C-unwind" fn ext_gui_get_size(
    ...
    unsafe {
        *width = crate::widener::gui::EDITOR_WIDTH;
        *height = crate::widener::gui::EDITOR_HEIGHT;
    }
    true
}
...
unsafe extern "C-unwind" fn ext_gui_set_parent(
    ...
    let parent = if api == CLAP_WINDOW_API_X11 {
        ...
        {
            crate::widener::gui::ParentWindowHandle::X11(unsafe { window.clap_window__.x11 })
        }
        ...
        #[cfg(target_os = "macos")]
        {
            crate::widener::gui::ParentWindowHandle::Cocoa(unsafe { window.clap_window__.cocoa })
        }
        ...
        {
            crate::widener::gui::ParentWindowHandle::Win32(unsafe { window.clap_window__.win32 })
        }
