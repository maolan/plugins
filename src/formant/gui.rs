...
fn view(state: &State) -> Element<'_, Message> {
    container(
        row![
            knob(ParamId::Vowel, "Vowel", state),
            knob(ParamId::Sharpness, "Sharpness", state),
            knob(ParamId::OutputGain, "Gain", state),
        ]
        .spacing(8)
...
impl crate::common::gui_bridge::GuiApp<super::plugin::SharedState> for App {
    ...
    fn parent_from_window(
        ...
        crate::formant::gui::parent_from_window(window, api)
    }
