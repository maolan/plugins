...
const PLUGIN_ID: &[u8] = b"com.maolan.saturator.stereo\0";
...
unsafe extern "C-unwind" fn ext_gui_is_api_supported(
    ...
    crate::saturator::gui::is_api_supported(api, is_floating)
}
...
unsafe extern "C-unwind" fn ext_gui_get_preferred_api(
    ...
    let preferred = crate::saturator::gui::preferred_api();
    unsafe {
...
unsafe extern "C-unwind" fn ext_gui_get_size(
    ...
    unsafe {
        *width = crate::saturator::gui::EDITOR_WIDTH;
        *height = crate::saturator::gui::EDITOR_HEIGHT;
    }
    true
}
...
unsafe extern "C-unwind" fn ext_gui_set_parent(
    ...
    let parent = if api == CLAP_WINDOW_API_X11 {
        ...
        {
            crate::saturator::gui::ParentWindowHandle::X11(unsafe { window.clap_window__.x11 })
        }
        ...
        #[cfg(target_os = "macos")]
        {
            crate::saturator::gui::ParentWindowHandle::Cocoa(unsafe { window.clap_window__.cocoa })
        }
        ...
        {
            crate::saturator::gui::ParentWindowHandle::Win32(unsafe { window.clap_window__.win32 })
        }
