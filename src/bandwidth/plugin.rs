...
const PLUGIN_ID: &[u8] = b"rs.maolan.bandwidth\0";
const PLUGIN_NAME: &[u8] = b"Maolan Bandwidth\0";
const PLUGIN_VENDOR: &[u8] = b"Maolan\0";
const PLUGIN_URL: &[u8] = b"\0";
const PLUGIN_VERSION: &[u8] = b"0.1.0\0";
const PLUGIN_DESCRIPTION: &[u8] = b"Tri-band M/S spatial processor\0";
...
unsafe extern "C-unwind" fn ext_gui_is_api_supported(
    ...
    crate::bandwidth::gui::is_api_supported(api, is_floating)
}
...
unsafe extern "C-unwind" fn ext_gui_get_preferred_api(
    ...
    let preferred = crate::bandwidth::gui::preferred_api();
    unsafe {
...
unsafe extern "C-unwind" fn ext_gui_get_size(
    ...
    unsafe {
        *width = crate::bandwidth::gui::EDITOR_WIDTH;
        *height = crate::bandwidth::gui::EDITOR_HEIGHT;
    }
    true
}
...
unsafe extern "C-unwind" fn ext_gui_set_parent(
    ...
    let parent = if api == CLAP_WINDOW_API_X11 {
        ...
        {
            crate::bandwidth::gui::ParentWindowHandle::X11(unsafe { window.clap_window__.x11 })
        }
        ...
        #[cfg(target_os = "macos")]
        {
            crate::bandwidth::gui::ParentWindowHandle::Cocoa(unsafe { window.clap_window__.cocoa })
        }
        ...
        {
            crate::bandwidth::gui::ParentWindowHandle::Win32(unsafe { window.clap_window__.win32 })
        }
